...
export default function Brand ({service}) {
  ...
  <div className="relative p-8 lg:py-14 px-6 md:px-12">
    <h2 className="mb-6 block font-sans text-3xl md:text-4xl font-medium leading-[1.5] tracking-normal text-white antialiased">
    {name}
    </h2>
